...
model_character = load_model(r'D:\Code_school_nam3ki2\TestModel\model\classfication_character\model_digits_v2.h5')
...
test_folder_path = r'D:\Code_school_nam3ki2\TestModel\CNN letter Dataset\CNN letter Dataset'
def getImageTrain(dirImg,lstImg,target_size=(40, 32)):        
...
data_test = getImageTrain(test_folder_path, [], target_size=(40, 32))
